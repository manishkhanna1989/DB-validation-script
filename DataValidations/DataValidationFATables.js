...
let resultStatus = '';
let timestamp ;
const filePath = 'Queries/FATables.json';
const csvPath = `Result_csv/${database}_Data_Validation_FATables.csv`;
const normalizeDateTimeColumn =
['fundclosedate', 'holiday','startdate','enddate','rundate','murexendtime','modifiedat','createdat','updatedat','approvedat','validfrom','validto','date','adjustmentdate','fxdate','closedate','expirydate','cobdate','lastmodified','generateddate','reportdate','publisheddate','statusmodifiedat'];
