...
const csvPath = `Result_csv/${database}Data_Validation.csv`;

const normalizeDateTimeColumn = ['lastupdate','warntime','effectivedate','unbumpedmaturitydate','underlyingeffectivedate', 'underlyingunbumpedeffectivedate','tradedate','date'];
