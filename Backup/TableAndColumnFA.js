...
// const database ='FundAccounting';  // Replace with your actual database name
...
const csvWriter = createCsvWriter({
    ...
    or  c.table_name = 'TradePnLExtendedProperties'
	and c.table_name not like '%pnl_%'
	and c.table_name not like '%tradedetails_%'
    `);
    const pgQuery =(`
        ...
        JOIN information_schema.tables t
            ...
            WHERE c.table_schema IN ('dbo')
            AND t.table_type = 'BASE TABLE'
	       and c.table_name not similar to '%pnl_+[0-9]+%'	
	       and c.table_name not like 'tradedetails_%'
